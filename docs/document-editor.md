...
The editor imports `.docx`, `.md` and `.mybook.md`; downloads `.docx` or `.md`. DOCX uses Mammoth for import and can simplify unsupported content. Markdown downloads preserve Writin metadata and custom blocks. Drive document copies still use `.mybook.md`.
