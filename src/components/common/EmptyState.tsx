...
export function EmptyState({ title, description, action }: EmptyStateProps) {
  return (
    <section className="flex flex-col items-center px-4 py-10 text-center" aria-labelledby="empty-state-title">
      <div className="mb-4 flex size-12 items-center justify-center rounded-xl bg-accent-soft text-accent-soft-foreground">
      ...
      <p className="mt-1 max-w-sm text-base leading-7 text-muted">{description}</p>
