...
export interface AudioEditLinkPopoverProps {
  /** Current audio URL to pre-fill */
  initialUrl: string
...
export function AudioEditLinkPopover({ initialUrl, onSave, onClose }: AudioEditLinkPopoverProps) {
  ...
  return (
    <div
      ...
      data-audio-edit-link-popover="true"
    >
      {/* Header */}
      <div className="mb-2.5 flex items-center justify-between px-1">
        ...
        <Button
          ...
          variant="ghost"
          size="icon-xs"
          aria-label="Close edit audio link"
          onClick={onClose}
