...
export const slashCommands: SlashCommand[] = [
  ...
  { id: 'document-link', title: 'Document link', description: 'Link to another document', keywords: ['document link', 'link to page', 'page link', 'internal link', 'document'], category: 'Media' },
