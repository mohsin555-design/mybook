...
export function AppLayout() {
  ...
  return (
    <div className="flex h-dvh min-h-[480px] flex-col overflow-hidden bg-background text-foreground">
      <header className="sticky top-0 z-30 shrink-0 border-b border-[var(--app-border)] bg-background/95 pt-[env(safe-area-inset-top)] backdrop-blur">
      ...
      <div className="mx-auto flex min-h-0 w-full max-w-[1600px] flex-1">
        <aside className="hidden w-60 shrink-0 flex-col border-r border-[var(--app-border)] bg-[var(--app-surface)] p-4 lg:flex">
        ...
        <main className="min-w-0 flex-1 overflow-y-auto overscroll-contain px-4 py-6 pb-[calc(5rem+env(safe-area-inset-bottom))] sm:px-6 lg:px-8 lg:pb-8">
